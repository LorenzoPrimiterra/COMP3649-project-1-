...
(4) interference.py          builds the interference graph and assigns registers.
    
(5) codegen.py               translates IR into assembly language.
    
(6) target.py                stores and formats the generated assembly.
