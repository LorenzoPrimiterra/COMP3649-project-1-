...
- Open and pass the input file to the parser.
...
- Interference graph construction or graph colouring (interference.py).
...
Exit Codes
----------
- 0 : allocation succeeded, assignments printed.
