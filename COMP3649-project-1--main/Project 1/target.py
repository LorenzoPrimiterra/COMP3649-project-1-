...
class TargetCode:
    """
    Represents a sequence of assembly instructions for a single basic block.

    Serves as a container for AsmInstruction objects and provides support
    routines for constructing and printing the target code sequence.
    """
    ...
    def add(self, instr: AsmInstruction) -> None:
        """
        Append an assembly instruction to the target code sequence.
