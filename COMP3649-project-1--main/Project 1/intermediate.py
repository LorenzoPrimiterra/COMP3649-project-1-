...
class IntermediateCode:
    ...
    def __init__(self, oplist: List[Operation] = None, live_out: List[str] = None):
        ...
        Parameters
        ----------
        oplist : List[Operation], optional
            List of Operation objects in program order.
        live_out : List[str], optional
            List of variable names live at block exit.
    ...
    def compute_liveness_info(self) -> None:
        ...
        Populates self.live_before and self.live_after by calling
        liveness.compute_liveness. Import is deferred to avoid circular
        imports between intermediate.py and liveness.py.
        """
        from liveness import compute_liveness  # local import to avoid circular imports
    ...
    def __str__(self) -> str:
        ...
        The output mirrors the original input format, with one instruction
        per line followed by the live-out line.
        """
